...
public class Controlador {
    ...
    public void iniciarSesion(Login inicio){
        ...
        if(inicio.user.getText().trim().equals("bramaca") && inicio.pass.getText().equals("tinker")){
            ...
            public void run(){
                try
                {
                    // Si no hay ningun error carga el splashscreen
                    inicio.dispose();
    ...
    public void mostrarInfo(JFrame frame){
        ...
        JOptionPane.showMessageDialog(frame, "Software elaborado por Brayan Mayta Cabrera\n "
            + "Version 1.0 - Organización del Computador - EMI\n                       ©CF&RQ - DVD\n "
            + "                               13 de Junio de 2023", "Información", JOptionPane.INFORMATION_MESSAGE, icono);
    }
